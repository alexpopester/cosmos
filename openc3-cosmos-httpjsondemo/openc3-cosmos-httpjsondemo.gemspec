...
Gem::Specification.new do |s|
  s.name = 'openc3-cosmos-httpjsondemo'
  s.summary = 'OpenC3 openc3-cosmos-httpjsondemo plugin'
  s.description = <<-EOF
    openc3-cosmos-httpjsondemo plugin for deployment to OpenC3
  EOF
  s.licenses = 'MIT'
  s.authors = ['Anonymous']
  ...
  s.metadata = {
    ...
    "openc3_store_title" => "HttpJsonDemo",
